...
class HistoricalAccountTest < ActiveSupport::TestCase
  ...
  test "returns political membership" do
    ...
    historical_account = build(:historical_account, political_party: PoliticalParty::Conservatives)
    assert_equal 'Conservative', historical_account.political_membership
  end
